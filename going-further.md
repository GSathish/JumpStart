...
layout: default
title: Going further
description: Extensions of the route problem, explaining engineering results, engineering failures and further reading.
...
Engineering beyond the sessions
{: .kicker}

# Going further

The route-choice problem shows how individual decisions can increase total travel time. We extend that example here, then examine engineering failures and a near miss to consider how design assumptions and the response to evidence affect a system's behaviour.
{: .lede}
